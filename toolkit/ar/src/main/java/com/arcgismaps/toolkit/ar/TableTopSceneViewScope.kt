...
public class TableTopSceneViewScope internal constructor(private val sceneViewScope: SceneViewScope) {
    ...
    ): Unit = Callout(location, modifier, offset, LeaderPosition.LowerMiddle, rotateOffsetWithGeoView, colorScheme, shapes, content)
    ...
    public fun Callout(
        ...
        shapes: CalloutShapes = CalloutDefaults.shapes(),
        content: @Composable BoxScope.() -> Unit
    ): Unit = Callout(geoElement, modifier, tapLocation, LeaderPosition.LowerMiddle, colorScheme, shapes, content)
    ...
    public fun Callout(
        ...
        shapes: CalloutShapes = CalloutDefaults.shapes(),
        content: @Composable BoxScope.() -> Unit
    ): Unit = sceneViewScope.Callout(location, modifier, offset, leaderPosition, rotateOffsetWithGeoView, colorScheme, shapes, content)
    ...
    public fun Callout(
        ...
        shapes: CalloutShapes = CalloutDefaults.shapes(),
        content: @Composable BoxScope.() -> Unit
    ): Unit = sceneViewScope.Callout(geoElement, modifier, tapLocation, leaderPosition, colorScheme, shapes, content)
}
