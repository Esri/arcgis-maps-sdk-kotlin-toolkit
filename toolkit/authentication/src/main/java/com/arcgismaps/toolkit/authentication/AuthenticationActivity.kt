 ...
 *      - Currently, IAP sign-out does not redirect back to the app, so you will not receive an intent in `onNewIntent`.
 *        Instead, this will need to be handled in `onResume` when the Custom Tab is closed.
