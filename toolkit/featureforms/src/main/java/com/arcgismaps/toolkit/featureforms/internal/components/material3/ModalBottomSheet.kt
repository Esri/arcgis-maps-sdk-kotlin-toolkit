...
import com.arcgismaps.toolkit.featureforms.internal.components.material3.gestures.DraggableAnchors
import com.arcgismaps.toolkit.featureforms.internal.components.material3.gestures.draggableAnchors
...
private class ModalBottomSheetDialogWrapper(
    ...
    ComponentDialog(
        ContextThemeWrapper(
            composeView.context,
            com.arcgismaps.toolkit.featureforms.R.style.OfflineEdgeToEdgeFloatingDialogWindowTheme
        )
    ),
