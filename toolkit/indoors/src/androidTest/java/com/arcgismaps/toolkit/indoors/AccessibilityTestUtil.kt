...
internal fun ComposeContentTestRule.checkAccessibility(
    ...
    val validator = AccessibilityValidator().setRunChecksFromRootView(true).setThrowExceptionFor(
        if (failOnViolation) AccessibilityCheckResultType.WARNING else null
