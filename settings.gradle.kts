...
include (":foo-app")
project(":foo-app").projectDir = File(rootDir, "microapps/FooApp/app")
include (":foo-app")
project(":foo-app").projectDir = File(rootDir, "microapps/FooApp/app")
include (":foo-app")
project(":foo-app").projectDir = File(rootDir, "microapps/FooApp/app")
include (":FooApp-app")
project(":FooApp-app").projectDir = File(rootDir, "microapps/FooApp/app")
include (":foo-app")
project(":foo-app").projectDir = File(rootDir, "microapps/FooApp/app")
include (":foo-app")
project(":foo-app").projectDir = File(rootDir, "microapps/FooApp/app")
include (":foo")
project(":foo").projectDir = File(rootDir, "toolkit/foo")
