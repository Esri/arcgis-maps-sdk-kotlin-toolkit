...
include (":subcomposition-app")
project(":subcomposition-app").projectDir = File(rootDir, "microapps/SubcompositionApp/app")
include (":subcomposition")
project(":subcomposition").projectDir = File(rootDir, "toolkit/subcomposition")
