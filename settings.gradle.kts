...
include(":utilitynetworktrace-app")
project(":utilitynetworktrace-app").projectDir = File(rootDir, "microapps/UtilityNetworkTraceApp/app")
include(":utilitynetwork")
project(":utilitynetwork").projectDir = File(rootDir, "toolkit/utilitynetwork")
