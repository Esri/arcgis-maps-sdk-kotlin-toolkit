...
android {
    namespace = "com.arcgismaps.toolkit.basemapgalleryapp"
    compileSdk = libs.versions.compileSdk.get().toInt()

    defaultConfig {
        applicationId ="com.arcgismaps.toolkit.basemapgalleryapp"
...
dependencies {
    ...
    "buildWithSourceCodeImplementation"(project(mapOf("path" to ":basemapgallery")))
    "buildWithMavenArtifactsImplementation"(arcgis.basemapgallery)
