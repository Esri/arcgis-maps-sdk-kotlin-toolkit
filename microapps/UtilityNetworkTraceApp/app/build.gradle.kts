...
android {
    namespace = "com.arcgismaps.toolkit.utilitynetworktraceapp"
    compileSdk = libs.versions.compileSdk.get().toInt()

    defaultConfig {
        applicationId ="com.arcgismaps.toolkit.utilitynetworktraceapp"
...
dependencies {
    ...
    "buildWithSourceCodeImplementation"(project(mapOf("path" to ":utilitynetworks")))
    "buildWithMavenArtifactsImplementation"(arcgis.utilitynetworks)
