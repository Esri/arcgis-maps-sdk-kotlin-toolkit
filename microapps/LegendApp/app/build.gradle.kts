...
android {
    namespace = "com.arcgismaps.toolkit.legendapp"
    compileSdk = libs.versions.compileSdk.get().toInt()

    defaultConfig {
        applicationId ="com.arcgismaps.toolkit.legendapp"
...
dependencies {
    ...
    "buildWithSourceCodeImplementation"(project(mapOf("path" to ":legend")))
    "buildWithMavenArtifactsImplementation"(arcgis.legend)
